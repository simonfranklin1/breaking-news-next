                            ...
                            <div className="flex items-center gap-4">
                                <div className="flex items-center gap-3">
                                    <Link href={user.id === post.creator._id ? "/profile" : "/profile/" + post.creator._id} className='text-lg text-blue-400 hover:underline'>
                                        <img src={post.creator.avatar} alt="creator" className={`${top ? "w-9 h-9" : "w-8 h-8"} rounded-full object-cover`} />
                                    </Link>
                                    <div className='opacity-85 flex gap-1 items-center'>
                                        ...
                                        {new Date(post.createdAt).toLocaleDateString("pt-BR", { hour: "2-digit", minute: "2-digit", year: "numeric", month: "short", day: "numeric" })}
                                    </div>
                                </div>
