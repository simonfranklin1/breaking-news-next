                        ...
                        <div className="lg:grid lg:grid-cols-4 sm:grid-cols-2 gap-6 sm:h-[530px] h-[470px] hidden">
                            ...
                            <div className='col-span-2'>
                                <Link href={"/posts/" + mostRated._id}>
                                    <div style={{ backgroundImage: `url(${mostRated.banner})`, backgroundSize: "cover", backgroundRepeat: "no-repeat", backgroundPosition: "center" }} className='w-full rounded-xl lg:h-[530px] h-[400px] flex justify-start items-end p-4 px-8 text-white relative object-cover object-center overflow-hidden shadow-md'>
                                        ...
                                        <div className="flex flex-col gap-2 z-10">
                                            ...
                                            <div className="lg:text-3xl sm:text-xl hidden sm:block font-news font-semibold">
                                                {truncateText(mostRated.title, 60)}
                                            </div>
